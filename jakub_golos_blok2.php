        ...
        <?php
            ...
            foreach ($zawodnicy as $value) {
                ...
                foreach ($value['okrazenia'] as $czas) {
                    $czasy[] = floor($czas / 60) . ":" . str_pad($czas % 60, 2, "0", STR_PAD_LEFT);
                }
                $srednia = round(array_sum($value['okrazenia']) / count($value['okrazenia']));
                $srednia = floor($srednia / 60) . ":" . str_pad($srednia % 60, 2, "0", STR_PAD_LEFT);
                if ($najlepsze < 300) {
                    $kategoria = "elita";
                    $elita++;
                ...
                echo "<td>" . floor($najlepsze / 60) . ":" . str_pad($najlepsze % 60, 2, "0", STR_PAD_LEFT) . "</td>";
                echo "<td>" . $srednia . "</td>";
...
<tfoot>
        <?php
            ...
            echo "<td colspan='2'> Najlepsze okrążenie: " . $najlepszeZawodow . "</td>";
